...
'use strict';
define(["exports", "./bucklescript/runtime/caml_builtin_exceptions", "./bucklescript/runtime/caml_float", "./bucklescript/stdlib/pervasives", "./bucklescript/runtime/block", "./bucklescript/runtime/curry"],
  function(exports, Caml_builtin_exceptions, Caml_float, Pervasives, Block, Curry){
    'use strict';
    ...
    var match = evaluate(/* Number */Block.__(0, [3]));
    
    if (match) {
      Pervasives.print_float(match[0]);
    }
    else {
      Pervasives.print_string("Error");
    }
    
    var match$1 = evaluate(/* Negative */Block.__(2, [/* Number */Block.__(0, [8])]));
    
    if (match$1) {
      Pervasives.print_float(match$1[0]);
    }
    else {
      Pervasives.print_string("Error");
    }
    
    var match$2 = evaluate(/* Plus */Block.__(3, [
            /* Negative */Block.__(2, [/* Number */Block.__(0, [3])]),
            /* Number */Block.__(0, [18])
          ]));
    
    if (match$2) {
      Pervasives.print_float(match$2[0]);
    }
    else {
      Pervasives.print_string("Error");
    }
