...
'use strict';
define(["exports", "./bytes", "../runtime/caml_builtin_exceptions", "./camlinternalLazy", "../runtime/caml_sys", "./pervasives", "../runtime/block", "../runtime/curry", "./printf", "./buffer", "./string", "../runtime/caml_string", "./random"],
  function(exports, Bytes, Caml_builtin_exceptions, CamlinternalLazy, Caml_sys, Pervasives, Block, Curry, Printf, Buffer, $$String, Caml_string, Random){
    'use strict';
    ...
    function is_relative(n) {
      if ((n.length < 1 || n.charCodeAt(0) !== /* "/" */47) && (n.length < 1 || n.charCodeAt(0) !== /* "\\" */92)) {
        if (n.length < 2) {
          return /* true */1;
        }
        else {
          return +(n.charCodeAt(1) !== /* ":" */58);
        }
      }
      else {
        return /* false */0;
